...
public:
    ...
    {
        return isLeapYear(Year) ? 366 : 365; // Fixed: 366 for leap year
    }
    ...
    bool IsDateBeforeDate2(clsDate Date2)
    {
        ...
        /*Method 2
            clsDate Date1 = *this;
            return (Date1._Year < Date2._Year) ? true : ((Date1._Year == Date2._Year) ? (Date1._Month < Date2._Month ? true : (Date1._Month == Date2._Month ? Date1._Day < Date2._Day : false)) : false); // 3
        */

        /*Method 3
            return (this->_Year < Date2._Year) ? true : ((this->_Year == Date2._Year) ? (this->_Month < Date2._Month ? true : (this->_Month == Date2._Month ? this->_Day < Date2._Day : false)) : false); // 2
        */
    }
